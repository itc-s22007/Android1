package jp.ac.it_college.std.s22007.hellosample
...
import jp.ac.it_college.std.s22007.hellosample.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
     ...
     */
    private lateinit var binding: ActivityMainBinding    //固定
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)

        //Binding クラスのインスタンスを生成してもらう
        binding = ActivityMainBinding.inflate(layoutInflater)  //固定

        //Binding クラスが管理しているビューを使う。
        setContentView(binding.root)  //固定
